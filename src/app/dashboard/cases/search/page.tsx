  ...
  return (
    <div className="p-6 max-w-2xl space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold tracking-tight">Adicionar processo</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Digite o número CNJ para cadastrar o processo e ativar o monitoramento automático.
        </p>
      </div>
      ...
      <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 flex gap-3">
        ...
        <div>
          <p className="text-sm font-medium">Tem muitos processos?</p>
          <p className="text-sm text-muted-foreground mt-0.5">
            Cadastre seu número de OAB e o Litix importa todos os seus processos
